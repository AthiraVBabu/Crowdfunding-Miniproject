...
function CreateProjectComponent(props) {
  ...
  async function submitProjectData(e) {
    ...
    const client = new Web3Storage({ token: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJkaWQ6ZXRocjoweDIzMmM4N0VkZjdjZjlDRTI0OUI0MDQzNTVhNUIzODU3NTE0ODJmYjciLCJpc3MiOiJ3ZWIzLXN0b3JhZ2UiLCJpYXQiOjE2ODE1MzIwMzA3NTgsIm5hbWUiOiJDcm93ZEZ1bmQifQ.YrkfGoQ4lLokTckcCD09wVoDlIPnE3TYoVMjleOxwhs"});
    e.preventDefault();
    if (inputImage) {
      try {
